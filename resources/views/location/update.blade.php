                ...
                <div class="panel-body">
                    <form action="{{ url('locations/update') }}" method="post">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtCouncil" name="Council_Name" value="{{ $loc->Council_Name }}" placeholder="Type the Council name, or click the map" />
                        </div>
						
						<div class="form-group">
                            <label for="txtContact">Contact Name</label>
                            <input type="text" class="form-control" id="txtContact" name="Contact_Name" value="{{ $loc->Contact_Name }}" placeholder="Enter the Council contact's name" />
                        </div>
						<div class="form-group">
                            <label for="txtPhone">Phone No.</label>
                            <input type="text" class="form-control" id="txtPhone" name="Phone_No" value="{{ $loc->Phone_No }}" placeholder="Enter the Council's contact number" />
                        </div>
						<div class="form-group">
                            <label for="txtEmail">Email Address</label>
                            <input type="text" class="form-control" id="txtEmail" name="Email_Add" value="{{ $loc->Email_Add }}" placeholder="Enter the Council contact's email address" />
                        </div>
						<div class="form-group">
                            <label for="txtAddress">Street Address</label>
                            <input type="text" class="form-control" id="txtAddress" name="Street_Address" value="{{ $loc->Street_Address }}" placeholder="Type the house number and street, or click the map"
								oninput="javascript:refreshMarker();" />
                        </div>
						<div class="form-group">
                            <label for="txtSuburb">Suburb</label>
                            <input type="text" class="form-control" id="txtSuburb" name="Suburb" value="{{ $loc->Suburb }}" placeholder="Type the suburb, or click the map"
								oninput="javascript:refreshMarker();" />
                        </div>
						<div class="form-group">
                            <label for="txtPostCode">Post Code</label>
                            <input type="text" class="form-control" id="txtPostCode" name="Postcode" value="{{ $loc->Postcode }}" placeholder="Type the post code, or click the map"
								oninput="javascript:refreshMarker();" />
                        </div>
						<div class="form-group">
